...
INSERT INTO #tblanguage (LanguageID,Name,TwoLetterID,ThreeLetterID,HorizontalOrder,HorizontalScroll,VerticalOrder,VerticalScroll) VALUES 
 (0,'DEFAULT','NA','NA',1,1,1,1),
 (1,'ENGLISH','EN','ENG',1,1,1,1),
 (2,'FRENCH','FR','FRA',1,1,1,1),
 (3,'GERMAN','DE','DEU',1,1,1,1),
 (4,'SPANISH','ES','SPA',1,1,1,1),
 (5,'DUTCH','NL','NLD',1,1,1,1),
 (6,'ITALIAN','IT','ITA',1,1,1,1),
 (7,'GREEK','EL','ELL',0,0,0,0),
 (8,'JAPANESE','JA','JPN',0,0,0,0),
 (9,'TRAD_CHINESE','ZH','ZHO',1,2,3,2),
 (10,'KOREAN','KO','KOR',0,0,0,0),
 (11,'INDONESIAN','ID','IND',0,0,0,0),
 (12,'ARABIC','AR','ARA',2,2,2,1),
 (13,'TURKISH','TR','TUR',0,0,0,0),
 (14,'MALAY','MS','MSA',0,0,0,0),
 (15,'FINNISH','FI','FIN',1,1,1,1),
 (16,'HINDI','HI','HIN',0,0,0,0),
 (17,'RUSSIAN','RU','RUS',1,1,1,1),
 (18,'PORTUGUESE','PT','POR',1,1,1,1),
 (19,'THAI','TH','THA',1,1,1,1),
 (20,'ROMANIAN','RO','RON',1,1,1,1),
 (21,'SERBIAN','SR','SRP',0,0,0,0),
 (22,'SWEDISH','SV','SVE',1,1,1,1),
 (23,'HUNGARIAN','HU','HUN',1,1,1,1),
 (24,'HEBREW','HE','HEB',2,2,2,1),
 (25,'POLISH','PL','POL',1,1,1,1),
 (26,'SIMP_CHINESE','HK','ZHK',1,2,3,2),
 (27,'VIETNAMESE','VI','VIE',1,1,1,1),
 (28,'SAMOAN','SM','SMO',1,1,1,1),
 (29,'TONGAN','TO','TON',1,1,1,1),
 (30,'CZECH','CS','CES',1,1,1,1),
 (31,'DANISH','DA','DAN',1,1,1,1),
 (32,'ICELANDIC','IS','ISL',1,1,1,1),
 (33,'KAZAKH','KK','KAZ',1,1,1,1),
 (34,'DARI','DI','PRS',2,2,2,1);
...
SELECT ConfigurationDefinitionID FROM tblConfigurationDefinitions 
							WHERE OutputTypeID IN (SELECT OutputTypeID FROM tblOutputTypes WHERE OutputTypeName IN ('CES'))
DECLARE @cnt INT
